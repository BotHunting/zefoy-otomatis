...
class zefoy:
    ...
    def main(self):
        ...
        self.change_title("TikTok Automator using zefoy.com | Github: @BotHunting")
    ...
    def main_sleep(self, delay):
        while delay != 0:
            time.sleep(1)
            delay -= 1
            self.change_title(f"TikTok Zefoy Automator using Zefoy.com | Cooldown: {delay}s | Github: @BotHunting")
